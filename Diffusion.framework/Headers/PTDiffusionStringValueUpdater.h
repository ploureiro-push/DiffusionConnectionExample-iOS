...
/**
 @brief A string value updater may be used to update string topics by specifying
 new values.
 ...
 been replaced by PTDiffusionStringUpdateStream which is accessed using
...
@interface PTDiffusionStringValueUpdater : PTDiffusionValueUpdater
...
/**
 ...
 @since 6.0
 */
-(BOOL)getCachedValue:(NSString *_Nullable *_Nonnull)value
...
/**
 @brief Extension adding support for updating topics using string values.

 @since 6.0
 */
@interface PTDiffusionTopicUpdater (PTDiffusionStringValueUpdater)

/**
 Returns an updater that can be used for the string data type to apply value
 updates.
