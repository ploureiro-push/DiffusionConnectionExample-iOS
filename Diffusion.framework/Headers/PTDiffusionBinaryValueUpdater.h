...
/**
 @brief A binary value updater may be used to update binary topics by specifying
 new values.
 ...
 been replaced by PTDiffusionBinaryUpdateStream which is accessed using
...
@interface PTDiffusionBinaryValueUpdater : PTDiffusionValueUpdater
...
/**
 ...
 @since 6.0
 */
-(BOOL)getCachedValue:(PTDiffusionBinary *_Nullable *_Nonnull)value
...
-(void)updateWithTopicPath:(NSString *)topicPath
                     value:(PTDiffusionBinary *)value
         completionHandler:(void (^)(NSError * _Nullable error))completionHandler;

@end

/**
 @brief Extension adding support for updating topics using Binary values.

 @since 6.0
 */
@interface PTDiffusionTopicUpdater (PTDiffusionBinaryValueUpdater)

/**
 Returns an updater that can be used for the binary data type to apply value
 updates.
