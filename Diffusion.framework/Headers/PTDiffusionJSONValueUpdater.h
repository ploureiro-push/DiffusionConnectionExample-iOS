...
/**
 @brief A JSON value updater may be used to update JSON topics by specifying
 new values.
 ...
 been replaced by PTDiffusionJSONUpdateStream which is accessed using
...
@interface PTDiffusionJSONValueUpdater : PTDiffusionValueUpdater
...
/**
 @brief Extension adding support for updating topics using JSON values.

 @since 6.0
 */
@interface PTDiffusionTopicUpdater (PTDiffusionJSONValueUpdater)

/**
 Returns an updater that can be used for the JSON data type to apply value
 updates.
