...
/**
 ...
 @since 6.3
 */
@interface PTDiffusionRecordV2UpdateStream : PTDiffusionUpdateStream
...
/**
 ...
 @since 6.3
 */
@property(nonatomic, readonly) PTDiffusionRecordV2* value;
...
/**
 ...
 @since 6.3
 */
-(BOOL)      setValue:(PTDiffusionRecordV2 *)value
