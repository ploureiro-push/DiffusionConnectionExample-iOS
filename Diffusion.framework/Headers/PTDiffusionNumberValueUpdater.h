...
/**
 @brief A number value updater may be used to update numeric topics by
 specifying new values as NSNumber objects.
 ...
 been replaced by PTDiffusionNumberUpdateStream which is accessed using
...
@interface PTDiffusionNumberValueUpdater : PTDiffusionValueUpdater
...
/**
 ...
 has yet been sent, the value has been removed from the cache or the value has
 been explicitly set to `nil` by a preceding update.
 ...
 @since 6.0
 */
-(BOOL)getCachedValue:(NSNumber *_Nullable *_Nonnull)value
...
/**
 ...
 @param value The new value for the topic or `nil` to set to 'no value' (null).
 ...
 @exception NSInvalidArgumentException If either of the topicPath or
 completionHandler arguments are `nil`.
...
/**
 @brief Extension adding support for updating topics using numeric values.

 @since 6.0
 */
@interface PTDiffusionTopicUpdater (PTDiffusionNumberValueUpdater)

/**
 Returns an updater that can be used for int64 data types to apply value
 updates.
...
/**
 Returns an updater that can be used for doubleFloat data types to apply value
 updates.
